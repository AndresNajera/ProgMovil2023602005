...
$checkInformeSql = "SELECT id FROM informeTasquena WHERE expedienteJefe = '$expedienteJefe' AND fecha = '$fecha' AND turno = '$turno' LIMIT 1";
...
$sql = "INSERT INTO informeTasquena (terminal, expedienteJefe, turno, fecha) VALUES ('tasquena', '$expedienteJefe', '$turno', '$fecha')";
